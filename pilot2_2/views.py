...
class Welcome(Page):
    def before_next_page(self):
        ...
        self.participant.vars['q_1'] = Constants.questions[0][1]
        self.participant.vars['q_2'] = Constants.questions[1][1]
        self.participant.vars['q_3'] = Constants.questions[2][1]
        self.participant.vars['q_4'] = Constants.questions[3][1]
        self.participant.vars['q_5'] = Constants.questions[4][1]
        self.participant.vars['q_6'] = Constants.questions[5][1]
        self.participant.vars['q_7'] = Constants.questions[6][1]
        self.participant.vars['q_8'] = Constants.questions[7][1]
        ...
        self.player.question_1 = Constants.questions[0][0]
        self.player.question_2 = Constants.questions[1][0]
        self.player.question_3 = Constants.questions[2][0]
        self.player.question_4 = Constants.questions[3][0]
        self.player.question_5 = Constants.questions[4][0]
        self.player.question_6 = Constants.questions[5][0]
        self.player.question_7 = Constants.questions[6][0]
        self.player.question_8 = Constants.questions[7][0]
